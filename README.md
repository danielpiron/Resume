 ...
 * **Citigroup Derivatives Markets Inc. (CDMI), Jersey City, NJ** -
   VP Application Test Utility Development and DevOps ~ *2005-Present*
 ...
 * Accustomed to and thrives in a high pressure and fast paced working
   environment with rapid release cycles.
...
**VP Application Test Utility Development and DevOps** ~ *2005-Present*
 * Created test framework for high frequency trading application development.
   Framework allows users to specify database, marketdata, quant, and GUI user
 ...
 * Designed C++ wrapper to ITRS monitoring XMLRPC API reportin obscure
   ...
   firmwide efforts to adopt ITRS as a monitoring tool.
 ...
 * Tied Jira workflow to Bitbucket pull request approval and merge process
   ...
   succictly abided by audit requirements.
 * Collaborated closely with production staff creating a seamless process for
   transfering artifacts, documentation, database scripts, etc.
 ...
 * Lead effort to transition hundreds of developers from disparate teams and
   thousands of build artifacts from Perforce to Git.
